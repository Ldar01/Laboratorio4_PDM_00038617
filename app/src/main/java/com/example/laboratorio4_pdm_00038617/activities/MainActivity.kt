...
import com.example.laboratorio4_pdm_00038617.adapters.MovieAdapter
import com.example.laboratorio4_pdm_00038617.network.NetworkUtils
...
class MainActivity : AppCompatActivity() {
    ...
    fun addMovieToList(movie: Movie){
        ...
        Log.d("Number",movieList.toString())
    }
    ...
    private inner class FetchMovie: AsyncTask<String,Void,String>(){
        override fun doInBackground(vararg params: String?): String {
            ...
            return try {
                NetworkUtils().getResponseFromHttpUrl(movieName)
            } catch (e: IOException){
                ""
            }
        }
